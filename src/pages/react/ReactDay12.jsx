...
import {
  ...
  GitBranch, RefreshCw, Cpu, Activity, Clock, Trash2, Eye,
  Check, X, Sliders, Play, RotateCcw, Award, Sparkles, Flame
} from 'lucide-react';
...
const CodeBlock = ({ title, code }) => {
  ...
  const hlJS = (c) => {
    ...
    ['useRef','useMemo','useCallback','useState','useEffect','memo'].forEach(k => {
